# Ejercicio 03: Reglas del juego de mesa "Tres en Raya"
...
print("4. Continúa el jugador 'O' y así sucesivamente")
print("5. No se puede jugar en una casilla ocupada")
print("6. Gana el jugador que logre alinear tres símbolos")
print("   en línea horizontal, vertical o diagonal")
