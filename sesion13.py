...
# imprimir los 10 primeros numeros de la serie numeros cubicos 
# print("Ejercicio")
# for i in range(1,11):
#     print(i**3)
...
# ejercicio 2 imprimir la cantidad de 
# vrces de los elemnentos de la cadena  '⚽🏀🏐🎱' de acuerdo a su posicion 

# pelotas = '⚽🏀⚽🏐🏀' #tenia ahi las pelotas y puse otras :( era ⚽🏀🏐🎱
...
# ejericio 3 ingresa un numero por teclado y qye genero
# un contador hasta 0, si el numero es negativo no lo hace
...
# tarea!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# Ejercicio 4, Crear un ciclo 
# infinito que reciba un número por teclado y 
...
# Ejemplo 18, Crear una lista de los números pares 
# del 2 al 10 con condicional
# print ("Ejemplo 18")
...
# Crear una tupla de los números impares del 1 al 10 usando una 
# tupla por comprensión
